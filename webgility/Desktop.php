...
########################################### custamization ###########################################################			  
				...
				//$CreditMemoCollection['totalRecords']
				...
				foreach($CreditMemoCollection as $CreditMemo1)
				{
					...
					#$CreditMemo->setShippingAndHandling($CreditMemo1->shipping_incl_tax);
					#$CreditMemo->setAdjustmentRefund($CreditMemo1->adjustment);
					#$CreditMemo->setAdjustmentFee($CreditMemo1->adjustment);
					...
					#$totalccitemprice = $CreditMemo1->grand_total/$totalccitemqty;
					/*
					foreach ($CreditMemo1->getAllItems() as $CreditMemoItem) 
					{
						if(trim($CreditMemoItem->sku)=='')
